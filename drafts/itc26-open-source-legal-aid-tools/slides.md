...
- Examples:
	...
	- LACI
	- Docassemble
	- [Spark](https://www.igniterealtime.org/projects/spark/), an instant messenger MLSA relied on for **25** years!
...
.row.align-items-center.column-gap-lg[
  .col[
  ...
  .image-height-md.border.dim[
    ![Laci logo](assets/laci-logo.png)
  ]
]
...
???
**Q -> Jessica and Luigi: Community is definitely key. What goes into building/fostering one?**
...
???
**Q -> Alison: What key language should we include in an RFP?**
